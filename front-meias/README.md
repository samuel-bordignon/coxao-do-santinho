...
Este é o frontend em React para o sistema de controle de estoque da fábrica **“meia meia meia”**, que auxilia na gestão de produtos (modelos de meias) e nas movimentações realizadas pelos **divulgadores móveis**.
